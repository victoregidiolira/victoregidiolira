...
<h3 align="center">☕ Back-end Developer · 🐳 DevOps · ☁️ Cloud · 🇧🇷 Brasil</h3>

---

### ⚡ Sobre mim

🎓 Graduado em **Análise e Desenvolvimento de Sistemas** pela **FIAP** (dez/2025)  
🔧 Foco em **Back-end Java/Spring Boot**, **DevOps com Docker** e **infraestrutura em nuvem**  
📡 Apaixonado por **observabilidade**, **automação de pipelines** e sistemas escaláveis  
🧪 Gosto de laboratório próprio: homelab rodando Prometheus + Grafana + Nginx no Linux
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,spring,cs,dotnet,python,docker,azure,postgresql,linux,git,nginx,bash&theme=dark" />
</p>
...
| 💜 Projeto | 🧠 Descrição |
|------------|--------------|
| 💳 **[Autorizador](https://github.com/victoregidiolira/autorizador)** | API REST em **Java 25 + Spring Boot 4** simulando autorizador de transações de maquininha, com auditoria completa, **PostgreSQL 15** e stack 100% conteinerizada com **Docker Compose** |
| 📡 **[HomeLab](https://github.com/victoregidiolira/HomeLab)** | Infraestrutura monitorada com **Prometheus + Grafana**, proxy reverso **Nginx**, scripts Bash de automação e testes de carga — tudo orquestrado via **Docker Compose** no Linux |
| ☁️ **[MonitoringMottu](https://github.com/victoregidiolira/MonitoringMottu)** | Deploy de aplicação **.NET 8** na **Microsoft Azure** com App Services, SQL Server, Azure CLI e regras de firewall para comunicação segura |
